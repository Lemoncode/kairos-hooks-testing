...
> Update aquí: El equipo de Meta ya no te recomienda usar este hook para cargas asíncronas de datos 😵‍💫, según su página oficial, [you might not need an effect](https://react.dev/learn/you-might-not-need-an-effect), literalmente dicen
...
tirar de un setTimeout o hacer un llamada a un servidor, esto devolverá una promesa, no es nada seguro ejecutar esto directamente en un componente funcional
